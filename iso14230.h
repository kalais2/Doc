...
/******************************************************************************
* P U R P O S E: This module implements ISO 9141 / 14230
*******************************************************************************/
#ifndef _ISO9141_14230_H_
#define _ISO9141_14230_H_

#ifdef ISO9141_14230_C
#define SCOPE
#else
#define SCOPE extern
...
typedef struct {
	...
	uint8_t Data[ISO9141_14230_MAXINITDATA];	/* Address byte in case of 5 Baud
...
typedef struct {
	...
	uint8_t Data[ISO9141_14230_MAXINITDATA];	/* Key Bytes and Address byte
...
typedef struct {
	...
	uint8_t Data[ISO9141_14230_MAXRXMSGLEN];	/* Rx data bytes */
...
/* Union for Tx, Rx and Length Queue handlers */
typedef union {

	ISO9141_14230_TxMsg_S p_ISO9141_14230TxMsg_S;	/* Tx message */
	ISO9141_14230_RxMsg_S p_ISO9141_14230RxMsg_S;	/* Rx message */
	uint32_t RxTime;	/* Receive Timestamp */
	uint16_t RxLength;	/* Rx length */
...
/* enum for ISO9141_14230 Q status*/
typedef enum {
	ISO9141_14230_Q_OK,
	ISO9141_14230_Q_FULL,
	ISO9141_14230_Q_EMPTY
} ISO9141_14230_QSTATUS;

/* enum for ISO9141_14230 Q type */
typedef enum {
	ISO9141_14230_TX_Q,
	ISO9141_14230_RX_Q,
	ISO9141_14230_LEN_Q,
...
//void ISO9141_14230_UARTIntrHandler(uint8_t p_IntrType);
...
//__arm __irq void ISO9141_14230_PIOISR(void);
